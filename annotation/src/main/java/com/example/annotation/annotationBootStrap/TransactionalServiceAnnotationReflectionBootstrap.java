...
public class TransactionalServiceAnnotationReflectionBootstrap {
    ...
    public static void main(String[] args) {
        /**
         * 在java反射编程模型中，注解之间无法继承也不能实现接口
         * 不过java语言默认将所有注解实现Annotation接口，被标注的对象用
         * API AnnotatedElement表达。通过AnnotatedElement#getAnnotation(Class)方法返回指定类型的注解对象
         * 获取注解属性则需要显示地调用对应的属性方法
         */
